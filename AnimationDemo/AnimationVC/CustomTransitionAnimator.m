 ...
 */
- (CustomTransitionAnimator * _Nonnull)initWithAnimationDurationForward:(NSTimeInterval)forward
...
- (void)setDefaultAnimationDuration {
    ...
    kBackwardAnimationDuration = 0.5;
    kBackwardCompleteAnimationDuration = 0.15;
}
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    Protocol *animating = @protocol(CustomTransitionAnimating);
                         ...
                         completion:^(BOOL finished) {
                             [UIView animateWithDuration:kForwardCompleteAnimationDuration
                                              ...
                                              completion:^(BOOL finished) {
                                                  ...
                                                  if ([self.destinationTransition conformsToProtocol:@protocol(CustomTransitionAnimating)] &&
