...
@interface Animation3VC ()<UIViewControllerTransitioningDelegate>
{
    NSArray *ImageArray;
...
{
    [self performSegueWithIdentifier:@"SlowAnimationSegue" sender:self];
}
